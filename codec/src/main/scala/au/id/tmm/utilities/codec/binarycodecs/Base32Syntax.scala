...
trait Base32Syntax {
  ...
  private val base32Codec = new Base32(Int.MaxValue, Array.empty[Byte])
  ...
  implicit class Base32StringOps(private val s: String) {
    def parseBase32: Either[DecoderException, ByteArray] = Base32Syntax.this.parseBase32(s)
    def parseBase32Unsafe: ByteArray                     = parseBase32OrThrow(s)
  }

  implicit class Base32ByteArrayOps(private val bytes: ByteArray) {
    def asBase32String: String = Base32Syntax.this.asBase32String(bytes)
  }
